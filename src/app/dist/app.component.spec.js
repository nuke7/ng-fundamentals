...
describe('AppComponent', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_1.TestBed.configureTestingModule({
                        ...
                        declarations: [event_app_component_1.AppComponent]
                    }).compileComponents()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
    ...
    it('should create the app', function () {
        var fixture = testing_1.TestBed.createComponent(event_app_component_1.AppComponent);
    ...
    it('should render title', function () {
        ...
        expect((_a = compiled.querySelector('.content span')) === null || _a === void 0 ? void 0 : _a.textContent).toContain('ng-fundamentals app is running!');
    });
});
